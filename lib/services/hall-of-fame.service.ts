...
const ROLE_ORDER_RULES: RoleOrderRule[] = [
  ...
  { name: "4TH DIVISION WINNER", kind: "collective", orderIndex: 4, match: (s) => hasAllTokens(s, ["4th", "division", "winner"]) },
  { name: "CUP WINNER", kind: "collective", orderIndex: 5, match: (s) => hasAllTokens(s, ["cup", "winner"]) && !s.includes("supercup") && !s.includes("super cup") && !s.includes("nations cup") && !s.includes("summer cup") },
  { name: "SUPERCUP WINNER", kind: "collective", orderIndex: 6, match: (s) => (s.includes("supercup") || hasAllTokens(s, ["super", "cup"])) && !s.includes("mvp") },
  { name: "NATIONS CUP WINNER", kind: "collective", orderIndex: 7, match: (s) => hasAllTokens(s, ["nations", "cup", "winner"]) || hasAllTokens(s, ["ffl", "nations", "cup"]) },
  { name: "SUMMER CUP WINNER", kind: "collective", orderIndex: 8, match: (s) => hasAllTokens(s, ["summer", "cup", "winner"]) || hasAllTokens(s, ["ffl", "summer", "cup"]) },
  ...
  { name: "4TH DIVISION PICHICHI", kind: "individual", orderIndex: 113, match: (s) => s === "4th division pichichi" },
  { name: "1ST DIVISION PLAYMAKER", kind: "individual", orderIndex: 114, match: (s) => s === "1st division playmaker" },
  { name: "2ND DIVISION PLAYMAKER", kind: "individual", orderIndex: 115, match: (s) => s === "2nd division playmaker" },
  { name: "3RD DIVISION PLAYMAKER", kind: "individual", orderIndex: 116, match: (s) => s === "3rd division playmaker" },
  { name: "4TH DIVISION PLAYMAKER", kind: "individual", orderIndex: 117, match: (s) => s === "4th division playmaker" },
  { name: "1ST DIVISION FAYE", kind: "individual", orderIndex: 118, match: (s) => s === "1st division faye" },
  { name: "2ND DIVISION FAYE", kind: "individual", orderIndex: 119, match: (s) => s === "2nd division faye" },
  { name: "3RD DIVISION FAYE", kind: "individual", orderIndex: 120, match: (s) => s === "3rd division faye" },
  { name: "4TH DIVISION FAYE", kind: "individual", orderIndex: 121, match: (s) => s === "4th division faye" },
  { name: "1ST DIVISION TOTS", kind: "individual", orderIndex: 122, match: (s) => s === "1st division tots" },
  { name: "2ND DIVISION TOTS", kind: "individual", orderIndex: 123, match: (s) => s === "2nd division tots" },
  { name: "3RD DIVISION TOTS", kind: "individual", orderIndex: 124, match: (s) => s === "3rd division tots" },
  { name: "4TH DIVISION TOTS", kind: "individual", orderIndex: 125, match: (s) => s === "4th division tots" },
]
